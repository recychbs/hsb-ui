  ...
  return (
    <>
      <div
        ...
        style={{ width: "100%", paddingBottom: "50px", paddingTop: "70px" }}
      >
        <Headerdealer />
        <div className="agentdetails" id="agentdetails">
          ...
          <div className="phonemail">
            ...
            <div className="col-6 col-lg-6 col-sm-12 phonemail-gap">
              ...
              <p className="error-warning">{errors.panCardNumber}</p>
                ...
                <label className="HeadText">PanCard Image:</label>
              <div className="uploaddiv">
                <input
                  type="file"
          ...
          <div className="phonemail">
            ...
            <div className="col-6 col-lg-6 col-sm-12 phonemail-gap">
              ...
              <label className="HeadText">Vehicle Image:</label>
              <div className="uploaddiv">
                <input
                  type="file"
          ...
          <div>
            <label className="HeadText">Bank Account Name:</label>
            <input
              type="text"
          ...
          <div className="phonemail">
          <div className="col-6 col-lg-6 col-sm-12 phonemail-gap">
            <label className="HeadText">Post / Zip Code:</label>
            <input
              type="text"
              name="postcode"
